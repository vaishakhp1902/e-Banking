 ...
 * @author ISI
 */
@WebServlet(urlPatterns = {"/loanreq"})
...
//                  String sql2 ="insert into ministate values('"+id+"','"+fname+"','"+username+"','"+accno+"','"+amount+"','"+date+"','"+loanno+"')";
//                 PreparedStatement ps2 = con.prepareStatement(sql2);
//               ps2.executeUpdate();
               
                 String sql3 ="update loanview set status='"+status+"',loanno='"+loanno+"' where rid='"+rid+"'";
                 PreparedStatement ps3 = con.prepareStatement(sql3);
               ps3.executeUpdate();
               
               String sql4 ="delete from lrequest where rid='"+rid+"'";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(loanreq.class.getName()).log(Level.SEVERE, null, ex);
