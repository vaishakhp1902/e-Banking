...
<div id="container">
  ...
  <h1 style="color:white;background-color: deepskyblue">Home Loan Request</h1>
 ...
 <tr><td><b>Please fill the Following Details:</b> </td><td><input type="hidden" name="accno" value="<%=rs.getString(9)%>"/></td></tr>                       
         ...
         <table>
                     <tr><td>
                             Choosen Loan Type : </td><td><input type="radio" name="type" value="home" checked="checked" />Home Loan
                         </td></tr>
