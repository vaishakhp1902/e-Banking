...
<div id="container">
  ...
  <h1 style="color:white;background-color: deepskyblue">Fixed Deposit Search</h1>
 ...
 <center>
     ...
     <form action="fd" method="post">
             <table border="2" align="center">
                                    ...
                                    String fdno=(String)session.getAttribute("sfd");
                                

                                        try {
                                          
                                                Connection con = new db().getConnection();
                                            String sa = "select * from fd where fdno='"+fdno+"' and username='"+title+"'";
