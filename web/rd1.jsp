 ...
 <center>
     ...
     <form action="fd" method="post">
             <table border="2" align="center">
                                    ...
                                    String rdno=(String)session.getAttribute("rdno");
                                

                                        try {
                                          
                                                 Connection con = new db().getConnection();
                                            String sa = "select * from rd where username='"+title+"' and rdno='"+rdno+"'";
...
<tr><td>Deposit Amount:</td><td><%=rs.getString(4)%></td></tr>
 ...
 <tr><td>Deposit Date:</td><td><%=rs.getString(8)%></td></tr>
                                    ...
                                    <%	}
                                        ...
                                        <table>
                                            <tr style="color:black;background-color: yellow;font-size: 20px"><td>Click to View other Recurring Deposits :</td><td>
                                                    <form action="viewrd.jsp"><input type="submit" value="View Other Fixed Deposit" /> </form>
                                                    </a></td>
                                            </tr>
