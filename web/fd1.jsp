...
<div id="container">
  ...
  <h1 style="color:white;background-color: deepskyblue">Fixed Deposit Details</h1>
 ...
 <center>
     ...
     <form action="fd" method="post">
             <table border="2" align="center">
                                    ...
                                    String fdno=(String)session.getAttribute("fdno");
                                

                                        try {
                                          
                                                Connection con = new db().getConnection();
                                            String sa = "select * from fd where username='"+title+"' and fdno='"+fdno+"'";
                    ...
                    <tr style="color:black;background-color: yellow;font-size: 25px"><td>Fixed Deposit Number :</td><td><%=rs.getString(1)%></td></tr>
...
<tr><td>Deposit Amount:</td><td><%=rs.getString(4)%></td></tr>
 ...
 <tr><td>Fixed Deposit Interest :</td><td><%=rs.getString(6)%></td></tr>
 <tr style="color:black;background-color: yellow;font-size: 25px"><td>Net Fixed Deposit Amount :</td><td><%=rs.getString(7)%></td></tr>
 <tr><td>Deposit Date:</td><td><%=rs.getString(8)%></td></tr>
                                    ...
                                    <%	}
                                        ...
                                        <table>
                                            <tr style="color:black;background-color: yellow;font-size: 20px"><td>Click to View other Fixed Deposits :</td><td>
                                                    <form action="viewfd.jsp"><input type="submit" value="View Other Fixed Deposit" /> </form>
                                                    </a></td>
                                            </tr>
