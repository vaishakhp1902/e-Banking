...
<div id="container">
  ...
  <h1 style="color:white;background-color: deepskyblue">Fixed Deposit Creation</h1>
...
<tr><td>Country :</td><td><%=rs.getString(8)%></td></tr>
  ...
  <tr style="color:black;background-color: yellow;font-size: 25px"><td>Current Balance :</td><td><%=rs.getString(10)%></b></td></tr>
   <tr><td></td><td><input type="hidden" name="username" value="<%=rs.getString(2)%>"/></td></tr>                       
             
                <tr><td></td><td><input type="hidden" name="accno" value="<%=rs.getString(9)%>"/></td></tr>                       
         ...
         <table>
                     <tr><td>
                             Choose Fixed Deposit Term : </td><td><select name="fd">
                                 <option>3</option>
                                 <option>6</option>
                                    <option>9</option>
                                 <option>12</option>
                     ...
                     <tr>
                         <td>Enter Amount : </td><td><input type="text" name="famount" required style="border-radius:20px"></td>
                     </tr>
                     <tr><td><input type="submit" value="Fixed Desposit Value"></td><td><input type="reset" value="Clear All"/></td></tr>
         </table>
