     ...
     <%
                    ...
                    <form action="search" method="post">
                        <table><tr><td><input type="hidden" value="<%String name = (String) session.getAttribute("logname");out.print(name);%>" name="username"/></td></tr>
                                            <tr style="color:black;background-color: yellow;font-size: 20px"><td>Enter the Fixed Deposit Number :</td><td>
                                                    <input type="text" name="fdno" value="" required style="border-radius:20px"/>  </td>
                                            </tr>
